...
const prevGetComponentForState =
  AccountManagementStack.router.getComponentForState;
const prevGetComponentForRouteName =
  AccountManagementStack.router.getComponentForRouteName;
const prevGetActionCreators = AccountManagementStack.router.getActionCreators;
const prevGetPathAndParamsForState =
  AccountManagementStack.router.getPathAndParamsForState;
const prevGetActionForPathAndParams =
  AccountManagementStack.router.getActionForPathAndParams;
